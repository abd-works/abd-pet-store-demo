...
Walk Increment 4 scenarios through `docs/domain/crc.md` (object model refresh deferred to Engineering). *Guest checkout* coexists; *StripeWave* sole active *payment vendor*; mandatory *email verification* gates account-only features; deferred scope omitted.
...
**Source graph:** `docs/story/story-graph.json` (epic priority 4)
...
Source: docs/story/specification-by-example/increment-4-specification-by-example.md
