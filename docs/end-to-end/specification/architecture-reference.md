...
> **Walkthrough:** [`docs/increments/1-walk-in-driver/engineering/object-model.md`](../increments/1-walk-in-driver/engineering/object-model.md) Â· [`docs/increments/3-ship-to-home/engineering/object-model.md`](../increments/3-ship-to-home/engineering/object-model.md) Â· [`docs/increments/4-returning-customers/engineering/object-model.md`](../increments/4-returning-customers/engineering/object-model.md)
> **Interface spec (Inc 1):** [`docs/increments/1-walk-in-driver/specification/interface-design.md`](../increments/1-walk-in-driver/specification/interface-design.md)
> **Interface spec (Inc 2):** [`docs/increments/2-click-and-collect/specification/interface-design.md`](../increments/2-click-and-collect/specification/interface-design.md)
> **Interface spec (Inc 3):** [`docs/increments/3-ship-to-home/specification/interface-design.md`](../increments/3-ship-to-home/specification/interface-design.md)
> **Interface spec (Inc 4):** [`docs/increments/4-returning-customers/specification/interface-design.md`](../increments/4-returning-customers/specification/interface-design.md)
> **Increment 2 lo-fi:** [`docs/increments/2-click-and-collect/exploration/ux/mockups.md`](../increments/2-click-and-collect/exploration/ux/mockups.md)
> **Increment 3 AC:** [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
> **Increment 4 lo-fi:** [`docs/increments/4-returning-customers/exploration/ux/mockups.md`](../increments/4-returning-customers/exploration/ux/mockups.md)
> **Increment 4 AC:** [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
> **Increment 5 lo-fi:** [`docs/increments/5-pay-your-way/exploration/ux/mockups.md`](../increments/5-pay-your-way/exploration/ux/mockups.md)
> **Interface spec (Inc 5):** [`docs/increments/5-pay-your-way/specification/interface-design.md`](../increments/5-pay-your-way/specification/interface-design.md)
> **Increment 5 AC:** [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
> **Increment 5 walkthrough:** [`docs/increments/5-pay-your-way/engineering/object-model.md`](../increments/5-pay-your-way/engineering/object-model.md)
> **Increment 6 lo-fi:** [`docs/increments/6-pet-visits/exploration/ux/mockups.md`](../increments/6-pet-visits/exploration/ux/mockups.md)
> **Increment 6 AC:** [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
> **Increment 6 spec-by-example:** [`docs/end-to-end/specification/specification-by-example.md`](../end-to-end/specification/specification-by-example.md)
...
> Sources: layers and mechanism catalogue from [`architecture-blueprint.md`](./architecture-blueprint.md) Â§2â€“3; Increment 1 AC in [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md); Increment 2 AC in [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md); Increment 3 AC in [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md); Increment 4 AC in [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md); Increment 5 AC in [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md); interface specs in [`interface-design.md`](../increments/2-click-and-collect/specification/interface-design.md), [`interface-design.md`](../increments/3-ship-to-home/specification/interface-design.md), [`interface-design.md`](../increments/4-returning-customers/specification/interface-design.md), and [`interface-design.md`](../increments/5-pay-your-way/specification/interface-design.md); Increment 5 lo-fi in [`increment-5-pay-your-way.md`](../increments/5-pay-your-way/exploration/ux/mockups.md); walkthrough in [`increment-5-walkthrough.md`](../increments/5-pay-your-way/engineering/object-model.md); spec-by-example in [`specification-by-example.md`](../end-to-end/specification/specification-by-example.md); domain model in [`docs/end-to-end/specification/crc.md`](../end-to-end/specification/crc.md), [`docs/end-to-end/engineering/object-model.md`](../end-to-end/engineering/object-model.md), [`docs/increments/3-ship-to-home/engineering/object-model.md`](../increments/3-ship-to-home/engineering/object-model.md), and [`docs/increments/4-returning-customers/engineering/object-model.md`](../increments/4-returning-customers/engineering/object-model.md); spec-by-example in [`specification-by-example.md`](../end-to-end/specification/specification-by-example.md); UL in [`docs/end-to-end/exploration/domain/ubiquitous-language.md`](../end-to-end/exploration/domain/ubiquitous-language.md) (slot 119 Increment 5 refresh).
...
Implementation contract for Engineering â€” each row maps a mechanism to planned files, routes, and test naming (from [`interface-design.md`](../increments/3-ship-to-home/specification/interface-design.md) AC â†’ behaviour â†’ test mapping).
...
Implementation contract for Engineering â€” each row maps a mechanism to planned files, routes, and test naming (from [`interface-design.md`](../increments/4-returning-customers/specification/interface-design.md) AC â†’ behaviour â†’ test mapping).
...
Implementation contract for Engineering â€” each row maps a mechanism to planned files, routes, and test naming (from [`interface-design.md`](../increments/5-pay-your-way/specification/interface-design.md) AC â†’ behaviour â†’ test mapping). **15 AC clauses** across **3 stories** â€” test names use `Story â€” AC n: short label` pattern from interface spec.
...
Implementation contract for Engineering â€” each row maps a mechanism to planned files, routes, and test naming (from [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md) + [`increment-6-pet-visits.md`](../increments/6-pet-visits/exploration/ux/mockups.md)).
...
Increment 2 E2E paths (from [`interface-design.md`](../increments/2-click-and-collect/specification/interface-design.md) + AC):
...
Increment 3 E2E paths (from [`interface-design.md`](../increments/3-ship-to-home/specification/interface-design.md) + [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)):
...
Increment 4 E2E paths (from [`increment-4-returning-customers.md`](../increments/4-returning-customers/exploration/ux/mockups.md) + [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)):
...
Increment 5 E2E paths (from [`increment-5-pay-your-way.md`](../increments/5-pay-your-way/exploration/ux/mockups.md) + [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)):
...
Increment 6 E2E paths (from [`increment-6-pet-visits.md`](../increments/6-pet-visits/exploration/ux/mockups.md) + [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)):
...
Increment 7 E2E paths (from [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)):
...
- [`docs/increments/1-walk-in-driver/exploration/ux/mockups.md`](../increments/1-walk-in-driver/exploration/ux/mockups.md)
- [`docs/increments/2-click-and-collect/exploration/ux/mockups.md`](../increments/2-click-and-collect/exploration/ux/mockups.md)
- [`docs/increments/2-click-and-collect/specification/interface-design.md`](../increments/2-click-and-collect/specification/interface-design.md)
- [`docs/increments/3-ship-to-home/specification/interface-design.md`](../increments/3-ship-to-home/specification/interface-design.md)
- [`docs/increments/4-returning-customers/specification/interface-design.md`](../increments/4-returning-customers/specification/interface-design.md)
- [`docs/increments/4-returning-customers/exploration/ux/mockups.md`](../increments/4-returning-customers/exploration/ux/mockups.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`docs/increments/5-pay-your-way/exploration/ux/mockups.md`](../increments/5-pay-your-way/exploration/ux/mockups.md)
- [`docs/increments/5-pay-your-way/specification/interface-design.md`](../increments/5-pay-your-way/specification/interface-design.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`docs/end-to-end/specification/specification-by-example.md`](../end-to-end/specification/specification-by-example.md)
- [`docs/increments/5-pay-your-way/engineering/object-model.md`](../increments/5-pay-your-way/engineering/object-model.md)
- [`docs/end-to-end/specification/specification-by-example.md`](../end-to-end/specification/specification-by-example.md)
- [`docs/end-to-end/specification/specification-by-example.md`](../end-to-end/specification/specification-by-example.md)
- [`docs/increments/4-returning-customers/engineering/object-model.md`](../increments/4-returning-customers/engineering/object-model.md)
- [`docs/end-to-end/exploration/domain/ubiquitous-language.md`](../end-to-end/exploration/domain/ubiquitous-language.md)
- [`docs/end-to-end/specification/crc.md`](../end-to-end/specification/crc.md)
- [`docs/end-to-end/engineering/object-model.md`](../end-to-end/engineering/object-model.md)
...
- [`docs/increments/6-pet-visits/exploration/ux/mockups.md`](../increments/6-pet-visits/exploration/ux/mockups.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`docs/end-to-end/specification/specification-by-example.md`](../end-to-end/specification/specification-by-example.md)
- [`docs/end-to-end/exploration/stories/acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
...
<!-- migrated from: end-to-end/specification/architecture-reference.md -->
...
## increment-8-marketing-engine-reference

<!-- migrated from: increments/8-marketing-engine/specification/architecture-reference.md -->
...
>
> **Companion docs:** [`architecture-blueprint.md`](./architecture-blueprint.md) · [`architecture-reference.md`](./architecture-reference.md) · [`marketing-engine-ubiquitous-language.md`](../increments/8-marketing-engine/exploration/domain/ubiquitous-language.md) · [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md) · [`increment-8-marketing-engine.md`](../increments/8-marketing-engine/exploration/ux/mockups.md)
...
> Sources: layers from [`architecture-reference.md`](./architecture-reference.md) § Architecture Layers and [`architecture-blueprint.md`](./architecture-blueprint.md) §2–3; mechanisms from [`marketing-engine-ubiquitous-language.md`](../increments/8-marketing-engine/exploration/domain/ubiquitous-language.md) and [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md).
...
Increment 8 E2E paths (from [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)):
...
- [`marketing-engine-ubiquitous-language.md`](../increments/8-marketing-engine/exploration/domain/ubiquitous-language.md)
- [`acceptance-criteria.md`](../end-to-end/exploration/stories/acceptance-criteria.md)
- [`increment-8-marketing-engine.md`](../increments/8-marketing-engine/exploration/ux/mockups.md)
- [`increment-8-marketing-engine.drawio`](../increments/8-marketing-engine/exploration/ux/mockups.drawio)
