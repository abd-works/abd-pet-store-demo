...
> **Companion to** `docs/end-to-end/discovery/ux/information-architecture.drawio`. Author or update **this file first**, then drive the canvas from it. After the canvas is updated, sync any change back into this file so the two never diverge.
...
| Story map | [docs/end-to-end/discovery/stories/story-map.md](../story/story-map.md) |
| Thin slicing | [docs/end-to-end/discovery/stories/thin-slicing.md](../story/thin-slicing.md) |
| Ubiquitous language | [docs/end-to-end/exploration/domain/ubiquitous-language.md](../end-to-end/exploration/domain/ubiquitous-language.md) |
| Canvas | `docs/end-to-end/discovery/ux/information-architecture.drawio` |
| Last canvas update | 2026-05-24 |

## Description

First-pass IA for PawPlace Increment 1 — a payment-free, account-free walk-in driver. Customers discover stores via the [store locator](../end-to-end/exploration/domain/ubiquitous-language.md), browse the [product catalog](../end-to-end/exploration/domain/ubiquitous-language.md) by [category](../end-to-end/exploration/domain/ubiquitous-language.md), open a product detail page, and see per-store [stock availability](../end-to-end/exploration/domain/ubiquitous-language.md). Store employees update stock through a bare-bones [admin dashboard](../end-to-end/exploration/domain/ubiquitous-language.md) form. No cart, checkout, login, pets, or search screens appear in this increment.
...
| --- | --- | --- | --- |
| [store locator](../end-to-end/exploration/domain/ubiquitous-language.md) | screen name prefix | store locator — map view · store locator — list view | — |
| [store](../end-to-end/exploration/domain/ubiquitous-language.md) | row field · map point | store locator screens | map view · list view · store detail panel |
| [product catalog](../end-to-end/exploration/domain/ubiquitous-language.md) | screen name | product catalog | — |
| [category](../end-to-end/exploration/domain/ubiquitous-language.md) | filter label · row tag | product catalog | category filter · product row |
| [product](../end-to-end/exploration/domain/ubiquitous-language.md) | row field · header | product catalog · product detail page | product grid · product header |
| [product image](../end-to-end/exploration/domain/ubiquitous-language.md) | row field | product detail page | image gallery |
| [stock availability](../end-to-end/exploration/domain/ubiquitous-language.md) | region name · status label | product detail page | stock availability by store |
| [admin dashboard](../end-to-end/exploration/domain/ubiquitous-language.md) | screen name prefix | admin dashboard — stock levels | — |
...
- **Source:** [store locator](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [product catalog](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [product](../end-to-end/exploration/domain/ubiquitous-language.md) · [stock availability](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [admin dashboard](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [store](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [product](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [stock availability](../end-to-end/exploration/domain/ubiquitous-language.md)
...
- **Source:** [category](../end-to-end/exploration/domain/ubiquitous-language.md)
