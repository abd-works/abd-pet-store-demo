...
There is **no architecture outline on disk** for this brownfield engagement. Major systems are synthesized from [`docs/end-to-end/engineering/object-model.md`](../end-to-end/engineering/object-model.md), [`docs/end-to-end/exploration/domain/ubiquitous-language.md`](../end-to-end/exploration/domain/ubiquitous-language.md), the Increment 1 MERN spike under `packages/`, and the screen inventory in [`docs/end-to-end/discovery/ux/information-architecture.md`](../ux/information-architecture.md). Platform choice (MERN), deployment topology, and guiding principles are **implicit** from the spike and [`mern-technical-architecture`](../../.cursor/skills/mern-technical-architecture/SKILL.md) conventions; a formal outline may be produced later without contradicting this blueprint.
...
- [`docs/end-to-end/exploration/domain/ubiquitous-language.md`](../end-to-end/exploration/domain/ubiquitous-language.md) — canonical domain vocabulary
- [`docs/end-to-end/engineering/object-model.md`](../end-to-end/engineering/object-model.md) — aggregate operations and invariants
- [`docs/end-to-end/discovery/ux/information-architecture.md`](../ux/information-architecture.md) — Increment 1 screens this architecture supports
- [`docs/end-to-end/discovery/stories/thin-slicing.md`](../story/thin-slicing.md) — increment scope and ordering
