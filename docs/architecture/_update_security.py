...
f = open(r'C:\dev\abd-pet-store-demo\docs\architecture\architecture-reference.md', 'r', encoding='utf-8-sig')
content = f.read()
f.close()
...
f = open(r'C:\dev\abd-pet-store-demo\docs\architecture\architecture-reference.md', 'w', encoding='utf-8-sig')
f.write(content)
f.close()
print('File saved.')
