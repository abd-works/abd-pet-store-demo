...
ul_source: docs/domain/ubiquitous-language.md (slot 69)
---
...
**UL alignment:** Domain terms and AC prose follow Increment 3 refresh in `docs/domain/ubiquitous-language.md` (slot 69): *shipping address*, *standard delivery*, *delivery option*, *ship-to-home fulfillment*, *order queue*, *tracking number*, *order status*, *order status page*, *shipping notification*, *guest email*.  
