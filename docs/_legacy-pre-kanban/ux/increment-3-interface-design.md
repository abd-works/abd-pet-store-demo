...
| Lo-fi reference | **Derived** from `docs/ux/lo-fi/increment-2-click-and-collect.md` + `docs/end-to-end/discovery/information-architecture.md` (plan waiver — no `increment-3` lo-fi file) |
