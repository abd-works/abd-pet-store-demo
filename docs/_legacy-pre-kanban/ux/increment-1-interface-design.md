...
> **Companion to** lo-fi `docs/ux/lo-fi/increment-1-walk-in-driver.md` / `.drawio`. Specification-stage spec; implementation and tests land in Engineering (prototype → ATDD → clean code). Code may exist as brownfield spike under `packages/` — this spec is authoritative for the slice refresh.
...
| Lo-fi reference | `docs/ux/lo-fi/increment-1-walk-in-driver.md` |
| Acceptance criteria | `docs/story/acceptance-criteria/increment-1-acceptance-criteria.md` |
