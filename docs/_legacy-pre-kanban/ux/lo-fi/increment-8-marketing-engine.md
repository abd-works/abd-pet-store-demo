...
> **Companion to** `docs/ux/lo-fi/increment-8-marketing-engine.drawio`. Author or update **this file first**, then regenerate the wireframe from the state file.
...
| Initial IA | `docs/end-to-end/discovery/information-architecture.md` (Increment 1 base; extends Increment 4 account patterns, Increment 6 staff dashboard) |
| AC source | `docs/story/acceptance-criteria/increment-8-acceptance-criteria.md` |
| Domain terms | `docs/domain/marketing-engine-ubiquitous-language.md` |
| State file | `docs/ux/lo-fi/increment-8-marketing-engine-state.json` |
| Wireframe | `docs/ux/lo-fi/increment-8-marketing-engine.drawio` |
...
```powershell
node "C:\dev\abd-pet-store-demo\.cursor\skills\abd-ux-mockup\scripts\drawio-mockup.mjs" save --state "docs/ux/lo-fi/increment-8-marketing-engine-state.json" --out "docs/ux/lo-fi/increment-8-marketing-engine.drawio"
```
