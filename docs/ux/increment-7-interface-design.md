...
> **Companion to** lo-fi `docs/ux/lo-fi/increment-7-returns-refunds.md` / `.drawio`. Specification-stage spec; implementation and tests land in Engineering (interface-design implementation pass → ATDD → clean code). Extends Increments 1–6 prototype under `packages/` — this spec is authoritative for the slice.
...
| Lo-fi reference | `docs/ux/lo-fi/increment-7-returns-refunds.md` |
| Acceptance criteria | `docs/story/acceptance-criteria.md` (Increment 7 section) |
| Domain terms | `docs/domain/ubiquitous-language.md` |
| Prior interface specs | `docs/ux/increment-5-interface-design.md`, `docs/ux/lo-fi/increment-6-pet-visits.md` |
