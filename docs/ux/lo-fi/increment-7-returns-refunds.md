...
| Initial IA | `docs/ux/information-architecture.md` (Increment 1 base; extends Increment 4 order history and account patterns) |
| AC source | `docs/story/acceptance-criteria/increment-7-acceptance-criteria.md` |
| Domain terms | `docs/domain/ubiquitous-language.md` (slot 171/172) |
