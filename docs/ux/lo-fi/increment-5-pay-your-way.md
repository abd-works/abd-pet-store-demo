...
| Initial IA | `docs/ux/information-architecture.md` (Increment 1 base; Increment 2–4 checkout patterns; Increment 5 payment screens AC-derived) |
| AC source | `docs/story/acceptance-criteria/increment-5-acceptance-criteria.md` |
| Domain terms | `docs/domain/ubiquitous-language.md` (slot 119) |
