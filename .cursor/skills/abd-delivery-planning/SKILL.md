...
| 5   | Engineering | Engineer      | Prototype → object model → ATDD → clean code | `engineering.md` |

**Families → roles:** story → Product Owner · domain → Business Expert · UX → UX Designer · **architecture & engineering → Engineer**. [team-roles.md](../../content/roles/team-roles.md)
