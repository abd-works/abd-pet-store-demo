...
| 5 | **engineering** | Engineer | Prototype → object model → ATDD → clean code |

**Not separate stages:** thin slicing (last in discovery), ATDD (skill 3 in engineering), legacy names (`prioritization`, `story definition`, `acceptance tests`, `code`).
