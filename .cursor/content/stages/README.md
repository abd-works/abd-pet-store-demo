...
## Practice skill families → team role

Four **team roles** map to four **families** (bootcamp lens colors). **Architecture and engineering are one family** — same **Engineer** role from outline through clean code.

| Family | Team role | Playbook |
| --- | --- | --- |
